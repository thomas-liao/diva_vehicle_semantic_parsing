...
file_handler = logging.FileHandler('def_rand_bkgd_v2data.L23d_pmc')  #@
...
def train(input_tfr_pool, val_tfr_pool, out_dir, log_dir, mean, sbatch, wd):
    ...
    with tf.Graph().as_default():
        ...
        hg_input, pred_3d = sk_net.modified_hg_preprocessing_with_3d_info_v2(images, 36 * 2, 36 * 3, reuse_=False, tp=True) # fix prep part  #@
        ...
        pred_keys_hm = hg._graph_hourglass_modified_v1(input=r3, dropout_rate=0.5, outDim=out_dim, tiny=False, modif=False, is_training=True) # shape=(16, 4, 64, 64, 36), dtype=float32) #@
...
if __name__ == '__main__':
    ...
    parser.add_argument(
        ...
        default='/data/tliao4/rigid_car_data/v1',
