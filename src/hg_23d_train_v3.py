...
file_handler = logging.FileHandler('train_log_hg_23d_v3_1.0_run1_8-10.L23d_pmc')
...
def train(input_tfr_pool, val_tfr_pool, out_dir, log_dir, mean, sbatch, wd):
    ...
    with tf.Graph().as_default():
        ...
        hg_input, pred_3d = sk_net.modified_hg_preprocessing_with_3d_info_v2(images, 36 * 2, 36 * 3, reuse_=False, tp=False) # fix prep part
        ...
        with tf.Session(config=config) as sess:
            ...
            model_saver_23d_v1.restore(sess, 'log_hg_s4_256_23d_v2_1.0/model/single_key_4s_hg_23d_v2_1.0-149999')
            ...
            model_prefix = os.path.join(out_dir, 'single_key_4s_hg_23d_v3_1.0_8-10')
            timer = 0
            timer_count = 0
...
if __name__ == '__main__':
    ...
    parser.add_argument(
        '--out_dir',
        type=str,
        default='log_hg_s4_256_23d_v3_1.0_8-10_largeLrStart',
