...
def evaluate(input_tfr, model_dir, mean, in_dir, out_dir, png_list):
    ...
    with tf.Graph().as_default():
        ...
        with tf.Session(config=config) as sess:
            ...
            model_saver.restore(sess, '/home/tliao4/Desktop/new_tf_car_keypoint/tf_car_keypoint/models/log_hg_s4_256_8gpu_server/model/single_key_4s_hg-190000')
            ...
            for i in xrange(niters):
                ...
                # print("key2d sanity check", key2d.shape)
...
if __name__ == '__main__':
    ...
    parser.add_argument(
        '--model_dir',
        type=str,
        default='/home/tliao4/Desktop/new_tf_car_keypoint/tf_car_keypoint/src',
        # default=''
    ...
    parser.add_argument(
        ...
        default='/home/tliao4/Desktop/multi_car_hg_plain2d_test',
